...
/*   Updated: 2025/05/15 15:47:38 by kwurster         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*where R = 2*(N·L)*N - L
*/
static	t_color	original_phong(const t_vec3 view_dir, const float l_attenuation,
					...
					t_intersection its, t_light_ray l)
{
	...
	diffuse = vec3_component_mul(object_color_at(its.object, its.point),
			light.color);
