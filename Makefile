...
#    Updated: 2025/04/15 16:11:09 by lmeubrin         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS := $(addprefix $(SRCS_DIR)/,\
		...
		cone.c \
		cone_utils.c \
		$(addprefix util/, quaternion.c color.c util.c vec3_0.c vec3_1.c vec3_2.c scene_malloc.c print_scene.c interval.c) \
